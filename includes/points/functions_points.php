...
* @version $Id: functions_points.php 806 2012-02-12 11:33:22Z femu $
...
class ultimate_points
{
	...
	*/
	function new_topic_ch($forum_id, $topic_id, $message, $post_approval)
	{
		global $db, $config, $user, $points_values;
		...
		// Update user points, if no approval is needed
	...
	**/
	function new_post_ch($forum_id, $post_id, $message, $post_approval)
	{
		global $db, $config, $user, $points_values;
	...
	*/
	function new_poll($forum_id, $post_id, $options, $post_approval)
	{
		global $db, $config, $user, $points_values;
	...
	*/
	function new_attachment($forum_id, $post_id, $files, $post_approval)
	{
		global $db, $config, $user, $points_values;
	...
	* Calculate and send points for starting a new topic
	*/
	function update_topic_ch($poster_id,$forum_id, $topic_id, $message, $post_approval)
	{
		global $db, $config, $user, $points_values;
	...
	* Calculate and send points for posting
	**/
	function update_post_ch($poster_id, $forum_id, $post_id, $message, $post_approval)
	{
		global $db, $config, $user, $points_values;
	...
	* Receive cash for creating new polls
	*/
	function update_poll($poster_id, $forum_id, $post_id, $options, $post_approval)
	{
		global $db, $config, $user, $points_values;
...
{
	global $db, $cache, $config, $points_config, $table_prefix;
